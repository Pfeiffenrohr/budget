	...
	public class KategorienUpdaten extends javax.servlet.http.HttpServlet {
		...
		public void performTask(javax.servlet.http.HttpServletRequest request,
			...
			try {
				...
				{
					out.println("<p>");
					out.println("Kategorie wird gel�scht...");
					out.println("<p>");
					if (db.deleteKategorieRecursive((String)hash.get("name")))
					{
					out.println("Kategorie und alle Untekategorien erfolgreich gel�scht");
					}
					else
					{
						out.println("<font color=\"red\">!!!Kategorie konte nicht gel�scht werden!!!</font>");
					}
				}
				else
